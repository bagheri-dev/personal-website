...
export const Hero = () => {
    return (
        <div className="relative pt-3 lg:pt-20 mb-8 lg:mb-[160px]">
                ...
                <div className="flex items-center justify-between flex-wrap lg:flex-nowrap gap-x-2">
                    ...
                    <div>
                        <div className="space-y-2">
                            ...
                            <p className="text-sm lg:text-2xl text-[#7E7E7E]">Building fast, user-friendly, and future-ready websites. With Next.js and React, we deliver an exceptional web design experience.</p>
                        </div>
